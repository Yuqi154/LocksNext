...
public class ClassicLockMenu extends AbstractContainerMenu {
    public final Level level;
    public final Player entity;
    public final LockType lockType;

    public ClassicLockMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(LNMenu.CLASSIC.get(), id);
