...
public class SimpleLockMenu extends AbstractContainerMenu {
    public final Level level;
    public final Player entity;
    public final LockType lockType;

    public SimpleLockMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(LNMenu.SIMPLE.get(), id);
